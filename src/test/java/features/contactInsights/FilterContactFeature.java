...
public class FilterContactFeature extends BasePo {
	...
	// private LoginSteps loginPage= new LoginSteps(); // Assuming a LoginPage class
	// for login functionality
	private SideMenuSteps sidemenuSteps = new SideMenuSteps(); // Assuming a DashboardPage class for navigation
	private ContactInsightsSteps contactInsightsPage = new ContactInsightsSteps(); // Assuming a ContactInsightsPage for
																					// Contact Insights specific actions
...
//        When the user clicks on the First Name dropdown in the Filter dialog
		filterContactsDialogSteps
				.whenTheUserClicksOnTheFirstNameLastNameEmailGroupCountryMobileChannelPreferencesSegmentDropdownInTheFilterDialog(
						"First Name");
//        And the user checks the checkbox in the AQAFirstName option in the expanded dropdown in the Filter dialog
		filterContactsDialogSteps.whenTheUserChecksUnchecksTheCheckboxInTheOptionInTheExpandedDropdownInTheFilterDialog(
				"checks", "AQAFirstName");
...
//        And all filtered results shown in the First Name column match the AQAFirstName filter criteria selected in the Filter Contacts dialog
		contactInsightsPage
				.thenAllFilteredResultsShownInTheColumnContainTheValueThatWasEnteredInTheSearchContactsInputField(ContactsOptionEnum.FirstName, "AQAFirstName");
	}
...
//    	    And the AQAFirstName option appears selected in the First Name filter in the Filter dialog
		filterContactsDialogSteps
				.thenTheOptionAppearsSelectedInTheFirstNameLastNameEmailGroupCountryMobileSegmentChannelPreferencesFilterInTheFilterDialog(
						"AQAFirstName", "First Name");
...
//    	    When the user clicks on the Close icon in the selected AQAFirstName option in the First Name filter in the Filter dialog
		filterContactsDialogSteps
				.whenTheUserClicksOnTheCloseIconInTheSelectedOptionInTheFirstNameFilterInTheFilterDialog("AQAFirstName",
						"First Name");
...
//    	    And the AQAFirstName option does not appear as selected in the First Name filter in the Filter dialog
		filterContactsDialogSteps.thenTheOptionDoesNotAppearAsSelectedInTheFirstNameGroupFilterInTheFilterDialog(
				"AQAFirstName", "First Name");
...
//    	    And the user checks the checkbox in the jor option in the expanded dropdown in the Filter dialog
		filterContactsDialogSteps
				.whenTheUserChecksUnchecksTheCheckboxInTheOptionInTheExpandedDropdownInTheFilterDialog("checks", "jor");
//    	    And the user collapses the expanded dropdown in the Filter dialog
		filterContactsDialogSteps.whenTheUserCollapsesTheExpandedDropdownInTheFilterDialog();
...
//    	    And the user checks the checkbox in the bribri880@email-temp.com option in the expanded dropdown in the Filter dialog
		filterContactsDialogSteps.whenTheUserChecksUnchecksTheCheckboxInTheOptionInTheExpandedDropdownInTheFilterDialog(
				"checks", "bribri880@email-temp.com");
//    	    And the user collapses the expanded dropdown in the Filter dialog
		filterContactsDialogSteps.whenTheUserCollapsesTheExpandedDropdownInTheFilterDialog();
...
//    	    And the user checks the checkbox in the SMS option in the expanded dropdown in the Filter dialog
		filterContactsDialogSteps
				.whenTheUserChecksUnchecksTheCheckboxInTheOptionInTheExpandedDropdownInTheFilterDialog("checks", "SMS");
//    	    And the user collapses the expanded dropdown in the Filter dialog
		filterContactsDialogSteps.whenTheUserCollapsesTheExpandedDropdownInTheFilterDialog();
